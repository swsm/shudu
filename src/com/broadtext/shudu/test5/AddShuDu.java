...
public class AddShuDu {
    ...
    public static void  main(String[] args) {
        ...
        System.out.println("数独生成时间：  " + (System.currentTimeMillis() - a));
...
//              {0, 9, 0, 0, 0, 0, 4, 0, 0}}; 
        ...
        Slove sl = new Slove(sd_); 
        sl.resolve(); 
        sl.Show_answer(); 
        System.out.println("数独解出时间：  " + (System.currentTimeMillis() - a));
